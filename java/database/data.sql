...
VALUES (5001, 'Check-Up', 'Ongoing', 'Just a quick check up!', '2023-05-10  14:00:00-04', 3001, 4000),
       ...
       (5005, 'Follow-Up', 'Ongoing', 'I need to follow-up on my medication.', '2023-04-14 11:30:00-04', 3012, 2001),
       (5006, 'Specific Symptoms', 'Ongoing', 'I am having trouble sleeping.', '2023-04-17 12:00:00-04', 3013, 4000),
       (5007, 'Vaccination', 'Ongoing', 'I need to get a flu shot.', '2023-04-18 13:30:00-04', 3015, 4001),
       (5008, 'Other', 'Ongoing', 'I want to discuss my diet and exercise routine.', '2023-04-19 14:00:00-04', 3017, 4002),
       (5009, 'Wellness Check-Up', 'Ongoing', 'I want to check if I am at risk for any diseases.', '2023-04-20 15:30:00-04', 3018, 4003),
       (5010, 'Follow-Up', 'Ongoing', 'I need to follow-up on my blood test results.', '2023-04-14 09:30:00-04', 3019, 4002),
       (5011, 'Specific Symptoms', 'Ongoing', 'I am experiencing chest pains.', '2023-04-17 10:00:00-04', 3020, 4001),
       (5012, 'Vaccination', 'Ongoing', 'I need to get a tetanus shot.', '2023-04-18 11:30:00-04', 3013, 4003),
       (5013, 'Other', 'Ongoing', 'I want to discuss my mental health.', '2023-04-18 12:00:00-04', 3014, 4000),
       (5014, 'Wellness Check-Up', 'Ongoing', 'I want to get a check-up on my overall health.', '2023-04-20 13:00:00-04', 3010, 4001),
       (5015, 'Follow-Up', 'Ongoing', 'I need to follow-up on my prescription.', '2023-04-18 14:00:00-04', 3012, 4003),
       (5016, 'Specific Symptoms', 'Ongoing', 'I am experiencing stomach pains.', '2023-04-20 15:00:00-04', 3014, 4002),
       (5017, 'Vaccination', 'Ongoing', 'I need to get a COVID vaccine.', '2023-04-21 09:30:00-04', 3016, 4000),
       (5018, 'Other', 'Ongoing', 'I want to discuss my family medical history.', '2023-04-24 10:00:00-04', 3018, 2001),
       (5019, 'Wellness Check-Up', 'Ongoing', 'Routine check-up', '2023-04-21 11:00:00-04', 3011, 2001),
       (5020, 'Follow-Up', 'Ongoing', 'Discussing the results of the recent test', '2023-04-20 11:30:00-04', 3012, 4001),
       (5021, 'Other', 'Ongoing', 'Discussion on new medication', '2023-04-19 12:00:00-04', 3013, 4000),
       (5022, 'Specific Symptoms', 'Ongoing', 'Recurring chest pain', '2023-04-20 12:30:00-04', 3014, 4003),
       (5023, 'Vaccination', 'Ongoing', 'First dose of vaccine', '2023-04-20 10:30:00-04', 3015, 4002),
       (5024, 'Other', 'Ongoing', 'Discussion on new medication', '2023-04-21 11:00:00-04', 3016, 2001),
       (5025, 'Wellness Check-Up', 'Ongoing', 'Routine check-up', '2023-04-21 12:30:00-04', 3017, 4001),
       (5026, 'Follow-Up', 'Ongoing', 'Discussing the results of the recent test', '2023-04-17 14:00:00-04', 3018, 4002),
       (5027, 'Other', 'Ongoing', 'Discussion on new medication', '2023-04-18 14:30:00-04', 3019, 4003),
       (5028, 'Specific Symptoms', 'Ongoing', 'Recurring chest pain', '2023-04-19 15:00:00-04', 3020, 4000),
       (5029, 'Vaccination', 'Ongoing', 'Second dose of vaccine', '2023-04-19 09:00:00-04', 3009, 4001),
       (5030, 'Other', 'Ongoing', 'Discussion on new medication', '2023-04-21 10:30:00-04', 3010, 4002),
       (5031, 'Wellness Check-Up', 'Ongoing', 'Routine check-up', '2023-04-20 11:00:00-04', 3011, 2001),
       (5032, 'Follow-Up', 'Ongoing', 'Discussing the results of the recent test', '2023-04-17 13:00:00-04', 3012, 4000),
       (5033, 'Other', 'Ongoing', 'Discussion on new medication', '2023-04-13 14:00:00-04', 3013, 4003),
       (5034, 'Follow-Up', 'Ongoing', 'Following up on medication regimen', '2023-04-13 09:00:00-04', 3009, 4000),
       (5035, 'Wellness Check-Up', 'Ongoing', 'Annual check-up', '2023-04-17 09:30:00-04', 3010, 4001),
       (5036, 'Specific Symptoms', 'Ongoing', 'Chest pain and shortness of breath', '2023-04-24 10:00:00-04', 3011, 4002),
       (5037, 'Vaccination', 'Ongoing', 'Flu shot', '2023-04-14 10:30:00-04', 3012, 4003),
       (5038, 'Other', 'Ongoing', 'Discussion of treatment options for chronic pain', '2023-04-13 11:00:00-04', 3013, 4000),
       (5039, 'Follow-Up', 'Ongoing', 'Following up on blood test results', '2023-04-13 11:30:00-04', 3014, 4001),
       (5040, 'Wellness Check-Up', 'Ongoing', 'Routine check-up', '2023-04-14 13:00:00-04', 3015, 4002),
       (5041, 'Specific Symptoms', 'Ongoing', 'Stomach pain and nausea', '2023-04-14 13:00:00-04', 3016, 4003),
       (5042, 'Vaccination', 'Ongoing', 'COVID-19 vaccine', '2023-04-19 13:30:00-04', 3017, 4000),
       (5043, 'Other', 'Ongoing', 'Discussion of allergy symptoms', '2023-04-18 14:00:00-04', 3018, 4001),
       (5044, 'Follow-Up', 'Ongoing', 'Following up on treatment for depression', '2023-04-17 15:00:00-04', 3019, 4002),
       (5045, 'Wellness Check-Up', 'Ongoing', 'Yearly physical', '2023-04-18 15:30:00-04', 3020, 4003),
       (5046, 'Specific Symptoms', 'Ongoing', 'Headaches and dizziness', '2023-04-17 16:00:00-04', 3013, 4000),
       (5047, 'Vaccination', 'Ongoing', 'COVID-19 vaccine', '2023-04-24 16:00:00-04', 3014, 4001),
       (5048, 'Other', 'Ongoing', 'Discussion of sleep issues', '2023-04-20 17:00:00-04', 3016, 4002),
       (5049, 'Follow-Up', 'Ongoing', 'Following up on treatment for anxiety', '2023-04-21 17:30:00-04', 3015, 4003),
       (5050, 'Specific Symptoms', 'Ongoing', 'Recurring chest pain', '2023-04-12 14:30:00-04', 3014, 4001);
